/*
  ...
  - You are about to drop the column `date` on the `ActivityEntry` table. All the data in the column will be lost.
  - You are about to drop the column `audience` on the `Broadcast` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `owner` on the `Incident` table. All the data in the column will be lost.
  - You are about to drop the column `date` on the `NewsItem` table. All the data in the column will be lost.
  - You are about to drop the column `desc` on the `NewsItem` table. All the data in the column will be lost.
  - You are about to drop the column `type` on the `NewsItem` table. All the data in the column will be lost.
  - You are about to drop the column `drop` on the `RiskAlert` table. All the data in the column will be lost.
  - You are about to drop the column `dayOfWeek` on the `ScheduleSlot` table. All the data in the column will be lost.
  - You are about to drop the column `published` on the `ScheduleSlot` table. All the data in the column will be lost.
  - You are about to drop the column `timeSlot` on the `ScheduleSlot` table. All the data in the column will be lost.
  - You are about to drop the column `password` on the `User` table. All the data in the column will be lost.
  - Added the required column `occurredAt` to the `ActivityEntry` table without a default value. This is not possible if the table is not empty.
  - Added the required column `audienceLabel` to the `Broadcast` table without a default value. This is not possible if the table is not empty.
  - Added the required column `audienceType` to the `Broadcast` table without a default value. This is not possible if the table is not empty.
  - Added the required column `displayValue` to the `Grade` table without a default value. This is not possible if the table is not empty.
  - Added the required column `ownerLabel` to the `Incident` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `KioskItem` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `category` to the `NewsItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `description` to the `NewsItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `publishedAt` to the `NewsItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `NewsItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `dropLabel` to the `RiskAlert` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `schedulePlanId` to the `ScheduleSlot` table without a default value. This is not possible if the table is not empty.
  - Added the required column `timeLabel` to the `ScheduleSlot` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `SchoolClass` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `Student` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `StudentGoal` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updatedAt` to the `TeacherTask` table without a default value. This is not possible if the table is not empty.
