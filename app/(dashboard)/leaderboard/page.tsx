...
import { Trophy, Medal, Star, Flame, Crown, ArrowUp, Zap } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1">
                ...
                <div className="lg:col-span-2 liquid-glass rounded-[2rem] p-0 overflow-hidden flex flex-col">
                    <div className="p-6 border-b border-border bg-white/50 backdrop-blur-md flex justify-between items-center">
                        ...
                        <select className="bg-transparent border border-border text-sm font-semibold rounded-lg px-2 py-1 text-muted-foreground focus:outline-none">
                    ...
                    <div className="flex-1 overflow-auto p-2">
                        {[
                            ...
                            <div key={i} className={`flex items-center gap-4 p-4 rounded-xl mb-1 ${student.me ? 'bg-primary/10 border border-primary/20 shadow-sm' : 'hover:bg-black/5'} transition-colors`}>
                                ...
                                <div className="flex items-center gap-4 text-right">
                                    ...
                                    {student.trend === "up" ? <ArrowUp className="w-4 h-4 text-green-500" /> : <ArrowUp className="w-4 h-4 text-red-500 rotate-180" />}
                                </div>
                            </div>
                        ))}
                    </div>
...
// Minimal mock icons missing from imports (Brain, ShieldCheck defined inline if needed)
