...
export default function ParentDashboard() {
    const [note, setNote] = useState("На этой неделе внимание стоит уделить физике и пропускам по истории.");
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-gradient-to-br from-[#f8f5ff] to-white border border-primary/20 p-6 rounded-[2rem] shadow-sm relative overflow-hidden">
                        ...
                        <div className="space-y-4 relative z-10">
                            ...
                            <button
                                onClick={() => setNote("Рекомендация сохранена: обсудить с Тимуром тайм-менеджмент и повторить тему по физике в эти выходные.")}
                            ...
                            >
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-sm text-foreground/80 leading-relaxed font-medium">
                                        Рекомендуется обсудить с Тимуром тайм-менеджмент и убедиться, что у него достаточно времени на выполнение заданий по предметам гуманитарного цикла.
                                    </p>
                                </div>
                            </button>
                        </div>
                    ...
                    <div className="liquid-glass p-6 rounded-[2rem]">
                        <div className="flex justify-between items-center mb-5">
                            ...
                            <button onClick={() => setNote("Открыта расширенная история оценок за последние 4 недели.")} className="text-xs font-semibold text-primary">Подробнее</button>
                        </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="liquid-glass p-6 rounded-[2rem]">
                        ...
                        <div className="space-y-4">
                            <button onClick={() => setNote("Напоминание сохранено: родительское собрание 18 Марта, 19:00, кабинет 302.")} className="w-full bg-white/50 p-4 rounded-xl border border-border flex items-start gap-3 text-left">
                            ...
                            <button onClick={() => setNote("Открыта новость: Тимур номинирован на городскую олимпиаду по физике.")} className="w-full bg-white/50 p-4 rounded-xl border border-border flex items-start gap-3 text-left">
